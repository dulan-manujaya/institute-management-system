...
import { EditIcon, TrashIcon, UploadIcon, MoneyIcon } from "../../icons";
      ...
      {!data ? (
        ...
        <>
          <div className="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
            <InfoCard value="Kivin Fonseka">
              <Avatar
                className="relative mr-4"
                src={
                  "https://img.icons8.com/dusk/64/000000/user-female-skin-type-1-2.png"
                }
                alt=""
                aria-hidden="true"
              />
            </InfoCard>
            <InfoCard value="Kenny Fonseka">
              <Avatar
                className="relative mr-4"
                src={
                  "https://img.icons8.com/dusk/64/000000/user-female-skin-type-1-2.png"
