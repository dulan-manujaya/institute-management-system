    ...
    <>
      ...
      {!data ? (
        ...
        <>
            ...
            <Table>
              ...
              <TableBody>
                <TableRow key="1" className="text-gray-700 dark:text-gray-300">
                  <TableCell>
                    <span className="text-sm">Term Exam - Jun 2021</span>
                  </TableCell>
                  <TableCell>
                  ...
                  <TableCell>
                    <div className="flex items-center space-x-4">
                      <Button size="small">View Paper</Button>
                      <Button size="small" onClick={openModal}>Submit Answer Sheet</Button>
                ...
                <TableRow key="1" className="text-gray-700 dark:text-gray-300">
                  <TableCell>
                    <span className="text-sm">Monthly Exam - Aug 2021</span>
                  </TableCell>
                  <TableCell>
                    <span className="text-sm">Physics</span>
                  </TableCell>
                  <TableCell>
                    <span className="text-sm">01-Aug-2021</span>
                  </TableCell>
                  <TableCell>
          ...
          <SectionTitle>Previous Exams</SectionTitle>
          <TableContainer>
            <Table>
              <TableHeader>
                <tr className="text-gray-700 dark:text-gray-200">
              ...
              <TableBody>
                <TableRow key="1" className="text-gray-700 dark:text-gray-300">
                  <TableCell>
                    <span className="text-sm">Monthly Exam - May 2021</span>
                  </TableCell>
                  <TableCell>
                  ...
                  <TableCell>
                    <div className="flex items-center space-x-4">
                      <Button size="small">View Paper</Button>
                      <Button size="small">View Answer Sheet</Button>
                    </div>
                  </TableCell>
                </TableRow>
                <TableRow key="1" className="text-gray-700 dark:text-gray-300">
